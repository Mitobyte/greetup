...
export const DateComponent = ({start, end})=>{
    ...
    const weekDay   = getWeekDay(startDate.getDay());
    const month     = getMonth(startDate.getMonth());
    const day       = getDay(startDate.getDay());
    const startTime = getTime(startDate.getHours(), startDate.getMinutes());
